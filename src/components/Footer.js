    ...
    <footer className="bg-white border-t py-4 mt-8">
      <div className="max-w-6xl mx-auto px-4 flex flex-wrap justify-between items-center">
        ...
        <div className="flex items-center text-blue-500 hover:text-blue-300 mb-1 md:mb-0">
          <span className="font-extrabold text-2xl ml-2">MyNFC</span>
        </div>

        {/* Copyright for mobile */}
        <div className="w-full text-center text-sm text-gray-500 order-3 md:order-2 md:w-auto mt-1 md:mt-0 md:flex-1 md:text-center">© {new Date().getFullYear()} MyNFC. All rights reserved.</div>
